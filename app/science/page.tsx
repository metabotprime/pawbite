...
const sections: ContentSection[] = [
  ...
  },
  {
    ...
    body: 'Our Daily Probiotic uses five strains chosen for documented benefit in dogs at the doses we ship. Each strain ID is on the label.\n\n**Bacillus coagulans GBI-30, 6086.** A spore-forming strain that survives stomach acid without enteric coating. The Kalman 2009 trial showed improved stool quality and reduced GI symptoms at 2 billion CFU/day in mammals; subsequent canine work has supported the result.\n\n**Bifidobacterium animalis subsp. lactis BB-12.** One of the most-studied probiotic strains across species. Eskesen 2015 demonstrated normalization of stool consistency and reduced GI discomfort. Survives gastric transit and adheres to the intestinal mucosa.\n\n**Lactobacillus plantarum 299v.** Saggioro 2004 showed measurable improvement in IBS-pattern symptoms and bloating in human studies; veterinary practice has extended its use for similar canine presentations.\n\n**Lactobacillus rhamnosus.** Nobaek 2000 documented reduced bloating and improved stool consistency. Often paired with B. lactis for additive effect on the gut barrier.\n\n**Lactobacillus reuteri.** Hatakka 2001 showed reduction in functional GI symptoms in pediatric populations; canine data supports use in stress-related GI flares (travel, boarding, antibiotic recovery).\n\nWe ship 5 billion total CFU per chew, guaranteed through end-of-shelf-life — not just at the time of manufacture. That distinction matters: many competitor labels list CFU at manufacture, which can be 40-60% higher than what reaches your dog 18 months later.',
  },
  {
